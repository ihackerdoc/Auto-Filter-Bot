...
USERNAME = environ.get('USERNAME', 'https://telegram.me/i_raunak')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002191068118'))
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002223245236').split()]
